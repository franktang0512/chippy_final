            ...
            <div style="background-image: url('./libs/notebook_back.png'); border-radius: 8px; display: block; padding: 5%; height: 90%;">
                <div style="border-radius: 8px; background-color: white; padding: 2%; display: block;height: 100%;">
                    ...
                    <div style="text-align: right;">
                        <button class="btn" style="display: inline; margin: 5px; background-color: blue; color: white;" onclick="judgeCode();<?php echo ($_SESSION["u_level"]=='0'?"submit_answer()":($_SESSION["u_level"]=='1'?"submit_answer_tea()":"")) ?>;"<?php //echo ($_SESSION["u_level"]=='1'?"disabled":"")?>>進行評分</button>
