...
Blockly.JavaScript['join'] = function(block) {
  var element0 = Blockly.JavaScript.valueToCode(block, 'TEXT0',
	  Blockly.JavaScript.ORDER_NONE) || '\'\'';
  var element1 = Blockly.JavaScript.valueToCode(block, 'TEXT1',
	  Blockly.JavaScript.ORDER_NONE) || '\'\'';
...
Blockly.JavaScript['length_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = '( typeof '+ list_name +'== \'object\'?'+list_name + ".length : 0)";
...
Blockly.JavaScript['getIndex_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = '( typeof '+ list_name +'== \'object\' ? '+list_name + '[' + index + '-1 ] : 0)'
  // console.log(code)
  return [code, Blockly.JavaScript.ORDER_MEMBER];
};
...
Blockly.JavaScript['remove_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = 'if( typeof '+ list_name +'== \'object\'){'+list_name + '.splice(' + index + '-1, 1);}\n'
  return [code, Blockly.JavaScript.ORDER_MEMBER]
};
...
Blockly.JavaScript['setIndex_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = 'if( typeof '+ list_name +'== \'object\' && '+index+'<='+list_name+'.length){'+list_name + '[' + index + '-1] = ' + value +'}\n';
  return code;
};
...
Blockly.JavaScript['insert_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code = 'if( typeof '+ list_name +'== \'object\'){'+list_name +'.splice( '+ index + '-1, 0, '+ value + ');}\nelse{'+list_name+'=['+value+']}\n';
  return code;
};
...
Blockly.JavaScript['add_list'] = function(block) {
  ...
  var list_name = Blockly.JavaScript.variableDB_.getName(
      block.getFieldValue('LIST'), Blockly.VARIABLE_CATEGORY_NAME);
  var code =  'if( typeof '+ list_name +'== \'object\'){'+ list_name + '.push(' + value + ');}\nelse{'+list_name+'=['+value+']}\n'
  return code;
}
