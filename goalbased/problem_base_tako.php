...
<body>
    ...
    <div id="view" class="column canvas-bg" style="position: relative;">
		...
		<button class="btn btn-lg" style="position: absolute; right: 100px; bottom: 20px; border: solid;" onclick="show_question(); document.getElementById('board_div').scrollTo(0, document.getElementById('board_div').scrollHeight)	">點我看測試資料</button>
