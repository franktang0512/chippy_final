	...
	if($bs =='0'){
		...
		<div class='container'>
			<div class='d-flex flex-wrap justify-content-left' style='display: inline;'>
				...
				<input id='file_id' type='text' placeholder='input file ID'>
				<button id='file_id_submit' class='submit' onClick='sadisplay()'>送出</button>
			</div>
...
<body>
	...
	<div class="workspace" id="scratchDiv2"></div>
...
輸出：
    ...
    <script>
		...
		function init() {
			...
			workspace_scratch = Blockly.inject('scratchDiv2',
            {
                toolbox: toolbox_scratch,
                zoom: 
                {
      ...
      // 執行程式碼
		...
		var inputValue = document.getElementById("file_id");
		var submitBtn = document.getElementById("file_id_submit");
		...
		submitBtn.addEventListener("click", getFileID());	
